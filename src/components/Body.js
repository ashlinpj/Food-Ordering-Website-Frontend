            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-6 sm:mb-8 gap-4">
                <div className="w-full md:w-1/2">
                    <div className="relative">
                        <input 
                            className="w-full px-3 sm:px-4 py-2 sm:py-3 rounded-lg border-2 border-gray-200 focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none transition-all duration-300 text-sm sm:text-base"
                            type="text" 
                        ...
                        />
                        <button 
                            className="absolute right-2 top-1/2 -translate-y-1/2 bg-green-500 text-white px-3 sm:px-4 py-1 sm:py-2 rounded-md hover:bg-green-600 transition-colors duration-300 text-sm sm:text-base"
                ...
                <button 
                    className="w-full md:w-auto px-4 sm:px-6 py-2 sm:py-3 bg-white text-green-600 border-2 border-green-500 rounded-lg font-medium hover:bg-green-50 transition-all duration-300 flex items-center justify-center gap-2 text-sm sm:text-base"
                    onClick={() => {
